### Models for predict metacognitive sensitivity from domains - Figure6a
...
# cargo los datos
filepath <- root$find_file("git/Data/Regression_Results/individual_mc_PID_domain_beta_model/escalada/DomainNegativeAffect.norm_mc_PID_domain_beta_model_escalada.RData")
load(file= filepath)
...
model <- rep("mixed logistic multivariate", length(terms))
...
ggsave("git/Figures/Figures/Figure6a.png", 
       width = 10, height = 6)
